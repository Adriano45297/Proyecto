...
<body>
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <li><a class="dropdown-item active" href="#">Montaña de 7 colores</a></li>
    ...
    <div class="card-group">
        <div class="card">
            <img src="img/monta1.jpg" class="card-img-top" alt="..." height="340">


        </div>
        <div class="card">
            <img src="img/monta2.jpg" class="card-img-top" alt="..." height="340">


        </div>
        <div class="card">
            <img src="img/monta3.jpg"card-img-top" alt="..." height="340">

        </div>
    </div>
    <div class="card text-center">
        <div class="card-header">
            PAQUETE MONTAÑA 7 COLORES
        </div>
        <div class="card-body">
            <h5 class="card-title">Características Montaña 7 colorores grupal-individual </h5>
            <ul class="list-group">
                <li class="list-group-item list-group-item-info">Concretamente estas son las características deMontaña 7 colorores Tour
                    grupal-individual que debes conocer antes de iniciar esta aventura:</li>
                <li class="list-group-item list-group-item-dark">Tipo de tour: Caminata
                ...
                <li class="list-group-item list-group-item-dark"> Recomendado: para aquellos que disfrutan de caminatas
                    cortas y tienen una condición física altas.
                </li>
                <li class="list-group-item list-group-item-dark">Consideraciones: Se requiere entradas para el ingreso
                    (EurekaExpedition lo obtendrá por usted en cuanto
                    reserve con nosotros). Se requiere reservar con anticipación.</li>
                <li class="list-group-item list-group-item-dark">Temporada:Todo el año.</li>
            </ul>
            <br>
            <a href="reservar.php" class="btn btn-primary">Reservar paquete a $80.00</a>
        </div>
