...
<body>
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <li><a class="dropdown-item active" href="#">Machu Picchu</a></li>
                            <li>
                                <hr class="dropdown-divider">
                            </li>
    ...
    <div class="card-group">
        <div class="card">
            <img src="img/mapi1.jpg" class="card-img-top" alt="...">


        </div>
        <div class="card">
            <img src="img/mapi2.jpg" class="card-img-top" height="325">


        </div>
        <div class="card">
            <img src="img/mapi3.jpg" class="card-img-top" alt="...">
    ...
    <div class="card text-center">
        ...
        <div class="card-body">
            <h5 class="card-title">Características Machu Picchu Tour grupal-individual </h5>
            <ul class="list-group">
                <li class="list-group-item list-group-item-info">Concretamente estas son las características de Machu Picchu Tour
                ...
                <li class="list-group-item list-group-item-dark"> Recomendado: para aquellos que disfrutan de caminatas
                    cortas y tienen una condición física moderada.
                </li>
            ...
            <br>
            <a href="reservar.php" class="btn btn-primary">Reservar paquete a $150.00</a>
        </div>
