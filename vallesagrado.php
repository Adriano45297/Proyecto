...
<body>
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <li><a class="dropdown-item active" href="#">Valle Sagrado</a></li>
                            <li>
    ...
    <div class="card-group">
        <div class="card">
            <img src="img/ollanta1.jpg" class="card-img-top" alt="...">


        </div>
        <div class="card">
            <img src="img/maras2.jpg" class="card-img-top" alt="..." height="364">


        </div>
        <div class="card">
            <img src="img/pisac3.jpg"card-img-top" alt="..." height="364">

        </div>
    </div>
    <div class="card text-center">
        <div class="card-header">
            PAQUETE VALLE SAGRADO
        </div>
        <div class="card-body">
            <h5 class="card-title">Características Valle sagrado Tour grupal-individual </h5>
            <ul class="list-group">
                <li class="list-group-item list-group-item-info">Concretamente estas son las características de Valle Sagrado Tour
            ...
            <br>
            <a href="reservar.php" class="btn btn-primary">Reservar paquete a $200.00</a>
        </div>
