...
<body>
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <li><a class="dropdown-item active" href="#">Inti Punku</a></li>
                        </ul>
                    </li>
                    <li class="nav-item">
    ...
    <div class="card-group">
        <div class="card">
            <img src="img/intipunku1.jpg" class="card-img-top" alt="..." height="340">


        </div>
        <div class="card">
            <img src="img/intipunku2.jpg" class="card-img-top" alt="..." height="340">


        </div>
        <div class="card">
            <img src="img/intipunku3.jpg"card-img-top" alt="..." height="340">
    ...
    <div class="card text-center">
        ...
        <div class="card-body">
            <h5 class="card-title">Características Inti Punku grupal-individual </h5>
            <ul class="list-group">
                <li class="list-group-item list-group-item-info">Concretamente estas son las características de Inti Punku Tour
            ...
            <br>
            <a href="reservar.php" class="btn btn-primary">Reservar paquete a $50.00</a>
        </div>
